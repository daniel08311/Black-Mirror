...
app.post('/bet',function(req,res){
	var ref = owner;
	if(req.body.ref!=ref && req.query.ref!="")
		ref = req.body.ref;
...
app.get('/bet',function(req,res){
	var ref = owner;
	if(req.query.ref!=ref && req.query.ref!="")
		ref = req.query.ref;
	res.sendFile(path.join(__dirname+'/bet.html'));
	io.sockets.on('connection', function (socket) {
		socket.emit('ref', {
